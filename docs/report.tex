...
Second, the dense method uses a simple pretrained CodeBERT model with mean
pooling. It is not fine-tuned for this exact retrieval task. It can find
semantically similar functions, but these functions are not always the paired
